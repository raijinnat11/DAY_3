...
class FacebookProfile {
    ...
    var bio = "Six foot two giraffe from the Lou   "
    var userName = "Karlie Kloss"
    var friendCount = 820000 // too many
    let birthday = "August 3, 1992"
    var relationshipStatus = "Married to the Music"
...
print(karlie) // prints the object as __lldb_expr_9.FacebookProfile 
